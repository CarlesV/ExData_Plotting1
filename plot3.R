...
# Line plot
with(data2days, plot(datetime, Sub_metering_1, xlab= " ", ylab= "Energy sub metering", type= "n"))
with(data2days, lines(datetime, Sub_metering_1, col= "black"))
